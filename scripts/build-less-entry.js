...
// Build a entry less file to dist/antd-mobile-rui.less
var fs = require('fs');
var path = require('path');

if(fs.existsSync(path.join(__dirname,'../dist'))) {
  console.log('Building a entry less file to dist/antd-mobile-rui.less');
...
// Build components in one file: lib/style/components.less
  fs.readdir(componentsPath, function (err, files) {
    ...
    fs.writeFileSync(
      path.join(process.cwd(), 'dist', 'antd-mobile-rui.less'),
