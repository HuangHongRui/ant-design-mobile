...
`antd-mobile-rui` is the React implementation of the [Ant Design](http://ant.design)'s mobile specification, serving the ant and koubei wireless service.
...
Can be an existing project, or a newly created empty project with [dva](https://github.com/dvajs/dva) / create-react(-native)-app, you can also copy and modify from the official example [scaffolding](https://github.com/ant-design/antd-mobile-rui-samples/tree/master/rn-web).

> More official [examples](https://github.com/ant-design/antd-mobile-rui-samples).
...
- Use [babel-plugin-import](https://github.com/ant-design/babel-plugin-import) (Recommended)
   ...
   {
     "plugins": [
       ["import", { "libraryName": "antd-mobile-rui", "style": "css" }] // `style: true` for less
     ]
   }
   ```

   This allows you to import components from antd-mobile-rui without having to manually import the corresponding stylesheet. The babel plugin will automatically import stylesheets.
...
- Manually import
   ...
   ```jsx
   import DatePicker from 'antd-mobile-rui/lib/date-picker';  // for js
   import 'antd-mobile-rui/lib/date-picker/style/css';        // for css
   // import 'antd-mobile-rui/lib/date-picker/style';         // that will import less
   ```
...
> Your custom UI library based on antd-mobile-rui: [web-custom-ui](https://github.com/ant-design/antd-mobile-rui-samples/tree/master/web-custom-ui) / [web-custom-ui-pro](https://github.com/ant-design/antd-mobile-rui-samples/tree/master/web-custom-ui-pro)
...
- Use [babel-plugin-import](https://github.com/ant-design/babel-plugin-import) (Recommended)
   ...
   {
     "plugins": [
       ["import", { libraryName: "antd-mobile-rui" }] // The difference with the Web platform is that you do not need to set the style
     ]
   }
   ```

   Then just change the way of import modules from antd-mobile-rui.
...
> [Custom theme and single component style](https://github.com/ant-design/antd-mobile-rui-samples/tree/master/rn-custom-ui)


## Version

- Stable: [![npm package](http://img.shields.io/npm/v/antd-mobile-rui.svg?style=flat-square)](http://npmjs.com/package/antd-mobile-rui)
- Next: [![npm package](https://img.shields.io/npm/v/antd-mobile-rui/next.svg)](http://npmjs.com/package/antd-mobile-rui)

## Size

- Components are loaded on demand, in other words, components that are not imported are not packed.
- <p><a href="https://ant-design.github.io/ant-design-analysis/" target="_blank">The size and dependency analysis</a> of `./dist/antd-mobile-rui.min.js`</p>
...
## Companies using antd-mobile-rui
...
If you'd like to help us improve antd-mobile-rui, just create a [Pull Request](https://github.com/ant-design/ant-design-mobile/pulls). Feel free to report bugs and issues [here](https://github.com/ant-design/ant-design-mobile/issues/new).
...
For questions on how to use antd, please post questions to [stackoverflow](http://stackoverflow.com/questions/tagged/antd) using the `antd`/`antd-mobile-rui` tag. If you're not finding what you need on stackoverflow, you can find us on [gitter](https://gitter.im/ant-design/ant-design-english?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge) as well.
